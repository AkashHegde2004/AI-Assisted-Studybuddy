...
def generate_study_content(topic, difficulty_level, content_type):
    ...
    try:
        ...
        with st.spinner(""):
            ...
            <p style="text-align: center;">🧠 AI is creating your personalized study materials...</p>
            """, unsafe_allow_html=True)
...
def generate_quiz_questions(topic, difficulty_level, num_questions):
    ...
    try:
        ...
        with st.spinner(""):
            ...
            <p style="text-align: center;">🎲 Creating your personalized quiz...</p>
            """, unsafe_allow_html=True)
...
def setup_sidebar():
    with st.sidebar:
        ...
        study_tips = [
            ...
            "Listen to classical music to enhance focus! 🎵",
            "Create mind maps to visualize complex information! 🗺️"
        ]
